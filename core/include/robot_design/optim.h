...
namespace robot_design {
    ...
    public:
        explicit DefaultInputSampler(Scalar history_std_dev = 0.05,
                                     Scalar warm_start_std_dev = 0.25);

        ~DefaultInputSampler() override = default;

        void sampleInputSequence(Ref<MatrixX> input_seq, unsigned int sample_seed,
    ...
    public:
        ConstantInputSampler() = default;

        ~ConstantInputSampler() override = default;
